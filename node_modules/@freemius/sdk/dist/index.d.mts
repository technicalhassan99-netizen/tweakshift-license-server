...
interface components {
  schemas: {
    ...
    Cart: {
       ...
       * @enum {string}
       */
      status: 'pricing_visit' | 'visit' | 'abandoned' | 'completed' | 'email_1_sent' | 'email_2_sent' | 'email_3_sent' | 'recovered';
      /**
    ...
    CouponEntity: {
       ...
       * @enum {string}
       */
      type?: 'affiliate' | 'renewals_discount' | 'manual_renewals_discount' | 'subscription_cancellation' | 'cart_recovery' | 'exit_intent';
    };
  ...
  parameters: {
     ...
     * @example cart_recovery
     */
    special_id: 'affiliate' | 'cart_recovery' | 'subscription_cancellation' | 'exit_intent' | 'renewals_discount' | 'manual_renewals_discount';
    /**
     * @description The ID of the review.
     * @example 1234
     */
...
type UserSubscriptionFilterOptions = ApiEntitiesFilter<operations['users/list-subscriptions']['parameters']['query']>;
 ...
 */
interface CheckoutRedirectData {
  /**
...
declare function isIdsEqual(id1: FSId, id2: FSId): boolean;
declare function parseBillingCycle(cycle?: BillingCycleApiEnum): BILLING_CYCLE;
declare function parseNumber(value: unknown): number | null;
declare function parseDateTime(dateString?: string | null): Date | null;
declare function parseDate(dateString?: string | null): Date | null;
...
declare abstract class ApiBase<EntityType, FilterType extends Record<string, unknown> = Record<string, unknown>> {
   ...
   * }
   */
  iterateAll(filter?: FilterType, pageSize?: number): AsyncGenerator<EntityType, void, unknown>;
  getPagingParams(paging?: PagingOptions): {
    count: number;
    offset: number;
  };
...
declare class License extends ApiBase<LicenseEntity, LicenseFilterOptions> {
  retrieve(licenseId: FSId): Promise<{
    id?: components["schemas"]["CommonProperties"]["id"];
    created?: components["schemas"]["CommonProperties"]["created"];
    updated?: components["schemas"]["CommonProperties"]["updated"];
    plugin_id?: components["schemas"]["CommonProperties"]["plugin_id"];
  ...
  retrieveMany(filter?: LicenseFilterOptions, pagination?: PagingOptions): Promise<({
    id?: components["schemas"]["CommonProperties"]["id"];
    created?: components["schemas"]["CommonProperties"]["created"];
    updated?: components["schemas"]["CommonProperties"]["updated"];
    plugin_id?: components["schemas"]["CommonProperties"]["plugin_id"];
  ...
  retrieveSubscription(licenseId: FSId): Promise<SubscriptionEntity | null>;
  retrieveCheckoutUpgradeAuthorization(licenseId: FSId): Promise<string | null>;
}
//#endregion
//#region src/api/Product.d.ts
declare class Product extends ApiBase<ProductEntity, never> {
...
declare class Subscription extends ApiBase<SubscriptionEntity, SubscriptionFilterOptions> {
  retrieve(subscriptionId: FSId): Promise<{
    user_id?: components["schemas"]["CommonProperties"]["user_id"];
    install_id?: components["schemas"]["CommonProperties"]["install_id_nullable"];
    plan_id?: components["schemas"]["CommonProperties"]["plan_id"];
    pricing_id?: components["schemas"]["CommonProperties"]["pricing_id_nullable"];
  ...
  retrieveMany(filter?: SubscriptionFilterOptions, pagination?: PagingOptions): Promise<({
    user_id?: components["schemas"]["CommonProperties"]["user_id"];
    install_id?: components["schemas"]["CommonProperties"]["install_id_nullable"];
    plan_id?: components["schemas"]["CommonProperties"]["plan_id"];
    pricing_id?: components["schemas"]["CommonProperties"]["pricing_id_nullable"];
...
declare class User extends ApiBase<UserEntity, UserFilterOptions> {
  retrieve(userId: FSId): Promise<{
    note?: string;
    is_marketing_allowed?: boolean | null;
    is_beta?: boolean;
    email?: string;
  ...
  retrieveMany(filter?: UserFilterOptions, pagination?: PagingOptions): Promise<{
    note?: string;
    is_marketing_allowed?: boolean | null;
    is_beta?: boolean;
    email?: string;
...
declare class ApiService {
   ...
   */
  generateAuthorizationParams(resourcePath: string, method?: 'POST' | 'PUT' | 'GET' | 'DELETE', jsonEncodedParams?: string, contentType?: string): ApiAuthParams;
  /**
...
declare class CheckoutRedirectInfo implements CheckoutRedirectData {
  user_id: string;
  plan_id: string;
  email: string;
  pricing_id: string;
...
//#endregion
//#region src/webhook/subscription.events.d.ts
interface SubscriptionEventDataMap {
...
declare class WebhookService {
   ...
   * ```
   */
  processFetch(listener: WebhookListener, request: Request): Promise<Response>;
  /**
